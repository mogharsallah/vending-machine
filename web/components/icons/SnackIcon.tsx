...
export const SnackIcon = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={classNames('w-5 h-5', className)} {...props}>
